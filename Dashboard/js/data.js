// Agent personality and profile data
const AGENTS = {
    chairman: {
        name: "Chairman",
...
// Sample metrics data with McKinsey KPIs
const METRICS = {
    chairman: {
        cards: [
...
// Sample red phone alerts
const RED_PHONE_ALERTS = [
...
// Sample table data for different dashboards
const TABLE_DATA = {
    cmo_roas: [
